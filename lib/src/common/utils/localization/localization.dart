...
/// Локализация
final class S extends generated.GeneratedLocalization {
  S._(this.locale);
  ...
  /// Текущий экземпляр локализации
  static S get current => _current;
  static late S _current;

  /// Получить инстанс локализации для структуры виджета
  static S of(BuildContext context) =>
      switch (Localizations.of<S>(context, S)) {
  ...
  /// Карта языков по ISO-кодам
  static const Map<String, (String name, String nativeName)> _isoLangs = <String, (String name, String nativeName)>{
    "ab": ('Abkhaz', 'аҧсуа'),
    "aa": ('Afar', 'Afaraf'),
...
@immutable
final class _LocalizationView extends LocalizationsDelegate<S> {
  @literal
  ...
  Future<S> load(Locale locale) =>
      generated.GeneratedLocalization.load(locale).then<S>(
          (localization) => S._current = S._(locale));
